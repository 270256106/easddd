...
import com.shunyi.ddd.eas.employeecontext.domain.exceptions.InvalidAttendanceException;
...
public class Attendance {
    ...
    private void assureStatus(boolean isHoliday, TimeCard timeCard, Leave leave) {
    ...
    private static class Condition{
        ...
        public Condition(boolean isHoliday, TimeCard timeCard, Leave leave) {
